...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      <schema location="../FindAgeBPELProcess.wsdl"/>
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [THU JAN 25 17:06:45 EST 2018]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <ns1:ResponseElement>
      <ns1:Response>
      <xsl:variable name="dob" select="/ns1:RequestElement/ns1:Request/ns1:DateOfBirth"/>
        <ns1:age>
